...
public interface TableFactory {
     ...
     */
    default Table create(ReportPage reportPage, String tableName, String lastRowString, Class<? extends TableColumnDescription> headerDescription) {
     ...
     * @param tableName table name's row should contain cell which starts with given text
     */
    default Table create(ReportPage reportPage, String tableName, Class<? extends TableColumnDescription> headerDescription) {
     ...
     * @param lastRowString table's last row should contain cell which starts with given text
     */
    default Table create(ReportPage reportPage, String tableName, String lastRowString, Class<? extends TableColumnDescription> headerDescription, int headersRowCount) {
     ...
     * @param tableName table name's row should contain cell which starts with given text
     */
    default Table create(ReportPage reportPage, String tableName, Class<? extends TableColumnDescription> headerDescription, int headersRowCount) {
     ...
     */
    default Table create(ReportPage reportPage, Predicate<Object> tableNameFinder, Predicate<Object> lastRowFinder, Class<? extends TableColumnDescription> headerDescription) {
     ...
     * @param tableNameFinder table name containing row should contain cell satisfying predicate
     */
    default Table create(ReportPage reportPage, Predicate<Object> tableNameFinder, Class<? extends TableColumnDescription> headerDescription) {
     ...
     * @param lastRowFinder   table's last row should contain cell satisfying predicate
     */
    default Table create(ReportPage reportPage, Predicate<Object> tableNameFinder, Predicate<Object> lastRowFinder, Class<? extends TableColumnDescription> headerDescription, int headersRowCount) {
     ...
     * @param tableNameFinder table name containing row should contain cell satisfying predicate
     */
    default Table create(ReportPage reportPage, Predicate<Object> tableNameFinder, Class<? extends TableColumnDescription> headerDescription, int headersRowCount) {
        String tableName = "<not found>";
     ...
     * @param lastRowString  table's last row should contain cell which starts with given text
     */
    default Table createNameless(ReportPage reportPage, String firstRowString, String lastRowString, Class<? extends TableColumnDescription> headerDescription) {
     ...
     * @param firstRowString table first row should contain cell which starts with given text
     */
    default Table createNameless(ReportPage reportPage, String firstRowString, Class<? extends TableColumnDescription> headerDescription) {
     ...
     * @param lastRowString     table's last row should contain cell which starts with given text
     */
    default Table createNameless(ReportPage reportPage, String providedTableName, String firstRowString, String lastRowString, Class<? extends TableColumnDescription> headerDescription, int headersRowCount) {
        return create(reportPage, providedTableName, // add fantom first line for provided table name
        reportPage.getTableCellRange(firstRowString, headersRowCount, lastRowString).// add fantom first line for provided table name
        addRowsToTop(1), headerDescription, headersRowCount);
    }
     ...
     * @param firstRowString    table first row should contain cell which starts with given text
     */
    default Table createNameless(ReportPage reportPage, String providedTableName, String firstRowString, Class<? extends TableColumnDescription> headerDescription, int headersRowCount) {
        return create(reportPage, providedTableName, // add fantom first line for provided table name
        reportPage.getTableCellRange(firstRowString, headersRowCount).// add fantom first line for provided table name
        addRowsToTop(1), headerDescription, headersRowCount);
    }
     ...
     * @param lastRowFinder  table's last row should contain cell satisfying predicate
     */
    default Table createNameless(ReportPage reportPage, Predicate<Object> firstRowFinder, Predicate<Object> lastRowFinder, Class<? extends TableColumnDescription> headerDescription) {
     ...
     * @param firstRowFinder table first row should contain cell satisfying predicate
     */
    default Table createNameless(ReportPage reportPage, Predicate<Object> firstRowFinder, Class<? extends TableColumnDescription> headerDescription) {
     ...
     * @param lastRowFinder     table's last row should contain cell satisfying predicate
     */
    default Table createNameless(ReportPage reportPage, String providedTableName, Predicate<Object> firstRowFinder, Predicate<Object> lastRowFinder, Class<? extends TableColumnDescription> headerDescription, int headersRowCount) {
        return create(reportPage, providedTableName, // add fantom first line for provided table name
        reportPage.getTableCellRange(firstRowFinder, headersRowCount, lastRowFinder).// add fantom first line for provided table name
        addRowsToTop(1), headerDescription, headersRowCount);
    }
     ...
     * @param firstRowFinder    table first row should contain cell satisfying predicate
     */
    default Table createNameless(ReportPage reportPage, String providedTableName, Predicate<Object> firstRowFinder, Class<? extends TableColumnDescription> headerDescription, int headersRowCount) {
        return create(reportPage, providedTableName, // add fantom first line for provided table name
        reportPage.getTableCellRange(firstRowFinder, headersRowCount).// add fantom first line for provided table name
        addRowsToTop(1), headerDescription, headersRowCount);
    }
