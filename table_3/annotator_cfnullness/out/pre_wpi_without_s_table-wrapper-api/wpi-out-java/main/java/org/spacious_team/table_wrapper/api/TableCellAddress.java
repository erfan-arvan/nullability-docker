...
public class TableCellAddress {
    ...
    public TableCellAddress(@org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull final int row, @org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull final int column) {
        this.row = row;
        this.column = column;
    }
}
