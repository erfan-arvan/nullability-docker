...
class ReportPageHelper {
    ...
    static Predicate<Object> getCellStringValueIgnoreCasePrefixPredicate(@org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull String prefix) {
