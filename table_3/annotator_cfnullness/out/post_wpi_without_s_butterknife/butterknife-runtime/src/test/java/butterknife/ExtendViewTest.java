...
public class ExtendViewTest {
    ...
    @Test
    public void views() {
        JavaFileObject source = JavaFileObjects.forSourceString("test.Test", "" + "package test;" + "import android.content.Context;" + "import android.view.View;" + "import butterknife.BindView;" + "public class Test extends View {" + "  Test(Context context) {" + "    super(context);" + "  }" + "  @BindView(1) View one;" + "}");
