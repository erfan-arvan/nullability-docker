...
public class OnItemClickTest {
    ...
    public void onItemClickBinding() {
        JavaFileObject source = JavaFileObjects.forSourceString("test.Test", "" + "package test;" + "import butterknife.OnItemClick;" + "public class Test {" + "  @OnItemClick(1) void doStuff() {}" + "}");
