...
public class RegistryClient {
    ...
    private Timer parentTimer = new Timer(new BuildLogger() {
        ...
        @Override
        public void debug(@Nullable() CharSequence message) {
        }

        @Override
        public void info(@Nullable() CharSequence message) {
        }
        ...
        @Override
        public void error(@Nullable() CharSequence message) {
        }
    }, "NULL TIMER");
     ...
     */
    @Nullable
    private <T> T callRegistryEndpoint(URL url, RegistryEndpointProvider<T> registryEndpointProvider) throws IOException, RegistryException {
        if (url == null) {
