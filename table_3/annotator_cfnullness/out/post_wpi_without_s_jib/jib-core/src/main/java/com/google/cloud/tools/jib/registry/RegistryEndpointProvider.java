...
interface RegistryEndpointProvider<T> {
     ...
     */
    URL getApiRoute(@Nullable() String apiRouteBase) throws MalformedURLException;
     ...
     */
    @Nullable
    T handleResponse(@Nullable() Response response) throws IOException, RegistryException;
