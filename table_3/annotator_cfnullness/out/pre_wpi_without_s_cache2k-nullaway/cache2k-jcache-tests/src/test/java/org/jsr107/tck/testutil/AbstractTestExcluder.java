...
public abstract class AbstractTestExcluder implements MethodRule {
     ...
     * {@inheritDoc}
     */
    public Statement apply(Statement statement, FrameworkMethod frameworkMethod, @Nullable() Object o) {
    ...
    protected abstract boolean isExcluded(@Nullable() String methodName);
