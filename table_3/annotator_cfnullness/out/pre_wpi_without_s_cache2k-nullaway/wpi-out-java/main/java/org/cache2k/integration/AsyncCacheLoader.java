...
public interface AsyncCacheLoader<K, V> {
    ...
    void load(@Nullable() K key, @org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull Context<K, V> context, @org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull Callback<V> callback) throws Exception;
