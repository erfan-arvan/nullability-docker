...
public interface Cache2kCoreProvider {
     ...
     */
    @org.checkerframework.dataflow.qual.Pure
    <K, V> Cache<K, V> createCache(@org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.Nullable @Nullable() CacheManager m, @org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull Cache2kConfig<K, V> cfg);
