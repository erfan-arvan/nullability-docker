...
public class UniversalResiliencePolicyUnitTest {
    ...
    public void testWithExpiryAndResilienceDuration() {
        UniversalResiliencePolicy p = policy(builder().expireAfterWrite(240000, TimeUnit.MILLISECONDS).with(UniversalResilienceConfig.class, b -> b.resilienceDuration(30000, TimeUnit.MILLISECONDS)));
    ...
    public void testWithExpiryAndResilienceDuration10Min30Sec() {
        UniversalResiliencePolicy p = policy(builder().expireAfterWrite(10, TimeUnit.MINUTES).with(UniversalResilienceConfig.class, b -> b.resilienceDuration(30, TimeUnit.SECONDS)));
        assertEquals(30000, p.getResilienceDuration());
        assertEquals(3000, p.getRetryInterval());
        assertEquals(30000, p.getMaxRetryInterval());
    }
    ...
    public void testWithExpiryAndRetryInterval() {
        UniversalResiliencePolicy p = policy(builder().expireAfterWrite(240000, TimeUnit.MILLISECONDS).with(UniversalResilienceConfig.class, b -> b.retryInterval(10000, TimeUnit.MILLISECONDS)));
    ...
    public void testWithExpiryAndMaxRetryInterval() {
        UniversalResiliencePolicy p = policy(builder().expireAfterWrite(240000, TimeUnit.MILLISECONDS).with(UniversalResilienceConfig.class, b -> b.maxRetryInterval(10000, TimeUnit.MILLISECONDS)));
        assertEquals(240000, p.getResilienceDuration());
        assertEquals(10000, p.getRetryInterval());
        assertEquals(10000, p.getMaxRetryInterval());
    }
    ...
    public void testCustomMultiplier() {
        UniversalResiliencePolicy p = policy(builder().expireAfterWrite(10000, TimeUnit.MILLISECONDS).with(UniversalResilienceConfig.class, b -> b.retryInterval(100, TimeUnit.MILLISECONDS).maxRetryInterval(500, TimeUnit.MILLISECONDS).resilienceDuration(5000, TimeUnit.MILLISECONDS).backoffMultiplier(2)));
    ...
    public void testSuppress() {
        UniversalResiliencePolicy p = policy(builder().expireAfterWrite(10000, TimeUnit.MILLISECONDS).with(UniversalResilienceConfig.class, b -> b.retryInterval(100, TimeUnit.MILLISECONDS).maxRetryInterval(500, TimeUnit.MILLISECONDS).resilienceDuration(5000, TimeUnit.MILLISECONDS)));
