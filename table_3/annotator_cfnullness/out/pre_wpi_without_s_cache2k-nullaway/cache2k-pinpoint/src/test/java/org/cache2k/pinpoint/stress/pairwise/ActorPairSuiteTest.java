...
public class ActorPairSuiteTest {
    ...
    public void exceptionPropagationFromSetup() {
        ActorPairSuite s = new ActorPairSuite().stopAtFirstException(true).addPair(new DefaultPair<Object>() {
    ...
    public void exceptionOnSecondRun() {
        ...
        ActorPairSuite s = new ActorPairSuite().runMillis(Long.MAX_VALUE).stopAtFirstException(true).addPair(new DefaultPair<Object>() {

            @Override
            public void check(@Nullable() final Object r1, @Nullable() final Object r2) {
    ...
    public void noExceptionOneshot() {
        ...
        ActorPairSuite s = new ActorPairSuite().runMillis(0).maxParallel(1234).addPair(new DefaultPair<Object>() {
    ...
    public void alternativeExecutor() {
        ...
        ActorPairSuite s = new ActorPairSuite().runMillis(0).maxParallel(1234).executor(new Executor() {
    ...
    static class DefaultPair<R> implements ActorPair<R> {
        ...
        @Override
        public void check(@Nullable() final R r1, @Nullable() final R r2) {
        }
    }
}
