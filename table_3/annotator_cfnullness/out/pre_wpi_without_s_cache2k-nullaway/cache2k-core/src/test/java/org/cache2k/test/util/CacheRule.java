...
public class CacheRule<K, V> implements TestRule {
    ...
    protected Cache2kBuilder<K, V> getInitialBuilder() {
        return Cache2kBuilder.forUnknownTypes().keyType(keyType).valueType(valueType).entryCapacity(10000).loaderThreadCount(4);
    }
    ...
    public interface Specialization<K, V> {
        ...
        void extend(@Nullable() Cache2kBuilder<K, V> b);
    }
