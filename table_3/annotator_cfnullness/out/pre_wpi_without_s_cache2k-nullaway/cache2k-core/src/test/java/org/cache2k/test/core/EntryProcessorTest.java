  ...
  */
    ...
    public void initial_noop() {
        ...
        EntryProcessor p = new EntryProcessor() {
            ...
            @Override
            public Object process(@Nullable() MutableCacheEntry e) {
                return null;
            }
        };
        ...
        EntryProcessor<Integer, Integer, String> p2 = new EntryProcessor<Integer, Integer, String>() {
            ...
            @Override
            public String process(@Nullable() MutableCacheEntry<Integer, Integer> e) {
                return "hello";
            }
        };
    ...
    public void exceptionPropagation() {
        ...
        c.invoke(KEY, new EntryProcessor<Integer, Integer, Object>() {
            ...
            @Override
            public Object process(@Nullable() MutableCacheEntry<Integer, Integer> e) {
    ...
    public void invokeAll_exception() {
        Cache<Integer, Integer> c = target.cache();
        Map<Integer, EntryProcessingResult<Object>> resultMap = c.invokeAll(toIterable(KEY), new EntryProcessor<Integer, Integer, Object>() {
    ...
    public void getCurrentTime_getRefreshTime_setRefreshTime_setValue() {
        ...
        c.invoke(1, new EntryProcessor<Integer, Integer, Object>() {
            ...
            public Object process(MutableCacheEntry<Integer, Integer> e) {
                assertThat(e.getStartTime(), greaterThanOrEqualTo(t0));
                assertThat("refresh time updated by put()", e.getModificationTime(), greaterThanOrEqualTo(t0));
    ...
    public void getValue_load() {
        ...
        }).isInstanceOf(EntryProcessingException.class).getCause().isInstanceOf(IllegalStateException.class);
    }
    ...
    public void load_changeRefreshTimeInLoader() {
        ...
        Cache<Integer, Integer> c = target.cache(new CacheRule.Specialization<Integer, Integer>() {
            ...
            @Override
            public void extend(Cache2kBuilder<Integer, Integer> b) {
                b.recordModificationTime(true).wrappingLoader(new AdvancedCacheLoader<Integer, LoadDetail<Integer>>() {

                    @Override
                    public LoadDetail<Integer> load(Integer key, @Nullable() long startTime, @Nullable() CacheEntry<Integer, LoadDetail<Integer>> currentEntry) {
    ...
    public void getValue_triggerLoad_remove_statistics() {
        ...
        target.statistics().getCount.expect(1).missCount.expect(1).loadCount.expect(1).expectAllZero();
        assertFalse(wl.cache.containsKey(123));
        Integer v = wl.cache.peek(123);
        assertNull(v);
        target.statistics().getCount.expect(1).missCount.expect(1).expectAllZero();
    }
    ...
    public void getValue_triggerLoad_exception_count_successful_load() {
        ...
        target.statistics().getCount.expect(1).missCount.expect(1).loadCount.expect(0).expectAllZero();
    }
    ...
    public void expires_before_mutation() {
        ...
        Cache<Integer, Integer> c = target.cache(new CacheRule.Specialization<Integer, Integer>() {
            ...
            @Override
            public void extend(Cache2kBuilder<Integer, Integer> b) {
                b.with(CoreConfig.class, b2 -> b2.timerReference(new SimulatedClock())).sharpExpiry(true).expiryPolicy((key, value, loadTime, oldEntry) -> loadTime + expireAfterWriteMillis).addListener((CacheEntryExpiredListener<Integer, Integer>) (cache, entry) -> {
        ...
        c.invoke(123, new EntryProcessor<Integer, Integer, Void>() {
            ...
            public Void process(MutableCacheEntry<Integer, Integer> e) {
                ...
                assertEquals("listener called before mutation lock", 1, listenerCallCount.get());
                return null;
            }
        });
    ...
    static class CountingWriter implements CacheWriter<Integer, Integer> {
        ...
        @Override
        public void delete(@Nullable() Integer key) {
            deleteCalled.incrementAndGet();
        }

        @Override
        public void write(@Nullable() Integer key, @Nullable() Integer value) {
    ...
    public void read_write_ep_executed_once_after_mutation_lock() {
        ...
        assertEquals("passed 4 times: initial/start, after installation read/examine, " + "after mutation lock/examine again, mutation", 4, count0.get());
        assertEquals("passed 1 times: after installation read, after mutation lock", 1, count1.get());
    }
    ...
    public void write_ep_executed_once() {
        ...
        assertEquals("passed 1 times: initial/start", 1, count0.get());
        assertEquals("passed 1 times: after installation read, after mutation lock", 1, count1.get());
    }
    ...
    public void getExceptionInfo() {
        ...
        LoadExceptionInfo<Integer> info = cl.cache.invoke(IdentCountingLoader.KEY_YIELDING_PERMANENT_EXCEPTION, entry -> {
            entry.load();
