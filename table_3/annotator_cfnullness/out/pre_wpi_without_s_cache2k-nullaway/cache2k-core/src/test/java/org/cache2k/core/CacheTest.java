...
public class CacheTest {
    ...
    public void testPeekAndPut() {
        Cache<String, String> c = Cache2kBuilder.of(String.class, String.class).eternal(true).build();
    ...
    public void testGetWithLoader() {
        ...
        Cache<String, Integer> c = Cache2kBuilder.of(String.class, Integer.class).loader(lengthCountingSource).eternal(true).build();
        int v = c.get("hallo");
        assertEquals(5, v);
        v = c.get("long string");
        assertEquals(11, v);
