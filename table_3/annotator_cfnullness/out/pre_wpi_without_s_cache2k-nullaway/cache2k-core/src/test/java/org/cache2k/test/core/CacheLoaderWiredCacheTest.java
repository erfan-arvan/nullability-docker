        ...
        Cache<Integer, Integer> c = target.cache(new CacheRule.Specialization<Integer, Integer>() {
            ...
            public void extend(final Cache2kBuilder<Integer, Integer> b) {
                b.loader(new CacheLoader<Integer, Integer>() {
                    ...
                    @Override
                    public void onEntryCreated(@Nullable() final Cache<Integer, Integer> c, @Nullable() final CacheEntry<Integer, Integer> e) {
        ...
        Cache<Integer, Integer> c = target.cache(new CacheRule.Context<Integer, Integer>() {
            ...
            public void extend(Cache2kBuilder<Integer, Integer> b) {
                b.loader(new AsyncCacheLoader<Integer, Integer>() {
                    ...
                    @Override
                    public void load(Integer key, Context<Integer, Integer> context, Callback<Integer> callback) {
