...
public abstract class Timing<K, V> {
    ...
    static final ExpiryPolicy<?, ValueWithExpiryTime> ENTRY_EXPIRY_CALCULATOR_FROM_VALUE = new ExpiryPolicy<Object, ValueWithExpiryTime>() {
        ...
        @Override
        public long calculateExpiryTime(@Nullable() Object key, ValueWithExpiryTime value, @Nullable() long loadTime, @Nullable() CacheEntry<Object, ValueWithExpiryTime> currentEntry) {
    ...
    public static <K, V> Timing<K, V> of(InternalCacheBuildContext<K, V> ctx) {
        ...
        ResiliencePolicy<K, V> resiliencePolicy = ctx.createCustomization(cfg.getResiliencePolicy(), ResiliencePolicy.disabledPolicy());
     ...
     */
    public void setTarget(@Nullable() TimerEventListener<K, V> c) {
    }
    ...
    public void close(@Nullable() InternalCacheCloseContext closeContext) {
    }
     ...
     */
    public abstract long calculateNextRefreshTime(@Nullable() Entry<K, V> e, @Nullable() V v, @Nullable() long loadTime);
     ...
     */
    public abstract long suppressExceptionUntil(@Nullable() Entry<K, V> e, @Nullable() LoadExceptionInfo inf);
     ...
     */
    public abstract long cacheExceptionUntil(@Nullable() Entry<K, V> e, @Nullable() LoadExceptionInfo inf);
     ...
     */
    public long stopStartTimer(long expiryTime, @Nullable() Entry<K, V> e) {
     ...
     */
    public boolean startRefreshProbationTimer(@Nullable() Entry<K, V> e, @Nullable() long nextRefreshTime) {
        return true;
    }
     ...
     */
    public void cancelExpiryTimer(@Nullable() Entry<K, V> e) {
    }

    /**
     * Schedule second timer event for the expiry tie if sharp expiry is switched on.
     */
    public void scheduleFinalTimerForSharpExpiry(@Nullable() Entry<K, V> e) {
    }
}
