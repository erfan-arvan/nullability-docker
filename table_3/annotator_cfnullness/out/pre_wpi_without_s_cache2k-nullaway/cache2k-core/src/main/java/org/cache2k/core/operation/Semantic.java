...
public interface Semantic<K, V, R> {
     ...
     */
    void start(@Nullable() Progress<K, V, R> c);
     ...
     */
    void examine(@Nullable() Progress<K, V, R> c, @Nullable() ExaminationEntry<K, V> e);

    /**
     * Perform the mutation. The mutation is done by calling the methods on {@link Progress}.
     */
    void mutate(@Nullable() Progress<K, V, R> c, @Nullable() ExaminationEntry<K, V> e);

    /**
     * Load is complete.
     */
    void loaded(@Nullable() Progress<K, V, R> c, @Nullable() ExaminationEntry<K, V> e);
    ...
    abstract class InsertOrUpdate<K, V, R> extends Base<K, V, R> {
         ...
         */
        @Override
        public final void examine(Progress<K, V, R> c, @Nullable() ExaminationEntry<K, V> e) {
            c.wantMutation();
        }
    }
    ...
    abstract class Read<K, V, R> extends Base<K, V, R> {
         ...
         */
        @Override
        public final void mutate(@Nullable() Progress<K, V, R> c, @Nullable() ExaminationEntry<K, V> e) {
        }
    }
}
