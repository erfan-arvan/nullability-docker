...
public class ExceptionWrapper<K> implements LoadExceptionInfo<K> {
    ...
    public ExceptionWrapper(K key, Throwable exception, long loadTime, Entry e, ExceptionPropagator<K> p) {
        this(key, exception, loadTime, (e.getValueOrException() instanceof ExceptionWrapper) ? (LoadExceptionInfo) e.getValueOrException() : e.getSuppressedLoadExceptionInformation(), p);
    }

    public ExceptionWrapper(K key, Throwable exception, long loadTime, LoadExceptionInfo w, ExceptionPropagator<K> p) {
        propagator = p;
