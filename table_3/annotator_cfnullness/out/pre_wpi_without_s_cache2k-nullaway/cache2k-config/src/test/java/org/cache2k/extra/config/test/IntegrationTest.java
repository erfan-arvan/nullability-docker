...
public class IntegrationTest {
    ...
    private Cache2kConfig cacheCfgWithLoader() {
        CacheManager mgr = CacheManager.getInstance("customizationExample");
        Cache2kConfig cfg = Cache2kBuilder.forUnknownTypes().manager(mgr).name("withLoader").config();
    ...
    public void defaultIsApplied() {
        assertEquals(5, new Cache2kBuilder<String, String>() {
        }.config().getLoaderThreadCount());
    }

    @Test
    public void defaultAndIndividualIsApplied() {
        Cache2kBuilder<String, String> b = new Cache2kBuilder<String, String>() {
    ...
    public void failIfConfigurationIsMissing() {
        ...
        }.manager(CacheManager.getInstance("empty")).name("missingDummy").build();
    }

    @Test(expected = ConfigurationException.class)
    public void failIfNameIsMissing() {
        new Cache2kBuilder<String, String>() {
        }.manager(CacheManager.getInstance("empty")).build();
    }
    ...
    public void unknownPropertyYieldsExceptionOnStartup() {
        try {
            new Cache2kBuilder<String, String>() {
            }.manager(CacheManager.getInstance("unknownProperty")).entryCapacity(1234);
    ...
    public void unknownPropertyYieldsExceptionOnBuild() {
        try {
            new Cache2kBuilder<String, String>() {
            }.manager(CacheManager.getInstance("specialCases")).name("unknownProperty").build();
            fail("expect exception");
        } catch (Exception ex) {
    ...
    public void sectionTypeNotFound() {
        try {
            new Cache2kBuilder<String, String>() {
            }.manager(CacheManager.getInstance("specialCases")).name("sectionTypeNotFound").build();
            fail("expect exception");
        } catch (Exception ex) {
    ...
    public void sectionTypeMissing() {
        try {
            new Cache2kBuilder<String, String>() {
            }.manager(CacheManager.getInstance("specialCases")).name("sectionTypeMissing").build();
            fail("expect exception");
        } catch (Exception ex) {
    ...
    public void templateNotFound() {
        try {
            new Cache2kBuilder<String, String>() {
            }.manager(CacheManager.getInstance("specialCases")).name("templateNotFound").build();
            fail("expect exception");
        } catch (Exception ex) {
    ...
    public void duplicateListener() {
        Cache c = new Cache2kBuilder<String, String>() {
        }.manager(CacheManager.getInstance("specialCases")).name("duplicateListener").build();
        c.close();
    }
    ...
    public void featureEnabled() {
        Cache c = new Cache2kBuilder<String, String>() {
        }.manager(CacheManager.getInstance("specialCases")).name("withFeature").build();
    ...
    public void featureDisabled() {
        Cache c = new Cache2kBuilder<String, String>() {
        }.manager(CacheManager.getInstance("specialCases")).name("withFeatureDisabled").build();
    ...
    public void notSerializableSection() {
        try {
            new Cache2kBuilder<String, String>() {
            }.manager(CacheManager.getInstance("notSerializable")).name("notSerializable").build();
            fail("expect exception");
        } catch (Exception ex) {
    ...
    public void parseError() {
        try {
            new Cache2kBuilder<String, String>() {
            }.manager(CacheManager.getInstance("parseError")).entryCapacity(1234);
            fail("expect exception");
        } catch (Exception ex) {
    ...
    public void parseErrorWrongXml() {
        new Cache2kBuilder<String, String>() {
        }.manager(CacheManager.getInstance("parseErrorWrongXml")).entryCapacity(1234);
    }

    @Test
    public void noManagerConfiguration() {
        new Cache2kBuilder<String, String>() {
        }.manager(CacheManager.getInstance("noManager")).entryCapacity(1234);
    }
    ...
    public void onlyDefault() {
        Cache2kConfig<String, String> cfg = new Cache2kBuilder<String, String>() {
        }.manager(CacheManager.getInstance("onlyDefault")).name("anyCache").config();
