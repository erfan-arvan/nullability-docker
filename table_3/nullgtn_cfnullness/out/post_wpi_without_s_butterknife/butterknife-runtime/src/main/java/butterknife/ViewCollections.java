...
public final class ViewCollections {
     ...
     */
    @UiThread
    public static <T extends View, V> void set(@NonNull List<T> list, @NonNull Setter<? super T, V> setter, V value) {
        for (int i = 0, count = list.size(); i < count; i++) {
     ...
     */
    @UiThread
    public static <T extends View, V> void set(@NonNull T[] array, @NonNull Setter<? super T, V> setter, V value) {
        for (int i = 0, count = array.length; i < count; i++) {
     ...
     */
    @UiThread
    public static <T extends View, V> void set(@NonNull T view, @NonNull Setter<? super T, V> setter, V value) {
     ...
     */
    @UiThread
    public static <T extends View, V> void set(@NonNull List<T> list, @NonNull Property<? super T, V> setter, V value) {
     ...
     */
    @UiThread
    public static <T extends View, V> void set(@NonNull T[] array, @NonNull Property<? super T, V> setter, V value) {
        //noinspection ForLoopReplaceableByForEach
        for (int i = 0, count = array.length; i < count; i++) {
     ...
     */
    @UiThread
    public static <T extends View, V> void set(@NonNull T view, @NonNull Property<? super T, V> setter, V value) {
