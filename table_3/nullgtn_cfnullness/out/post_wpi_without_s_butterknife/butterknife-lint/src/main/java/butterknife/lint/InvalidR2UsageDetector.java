...
public class InvalidR2UsageDetector extends Detector implements Detector.UastScanner {
    ...
    private static final Set<String> SUPPORTED_TYPES = ImmutableSet.of("array", "attr", "bool", "color", "dimen", "drawable", "id", "integer", "string");
    ...
    private static class R2UsageVisitor extends AbstractUastVisitor {
        ...
        private static void detectR2(JavaContext context, UElement node) {
            ...
            if (!classes.isEmpty() && classes.get(0).getName() != null) {
                ...
                if (qualifiedName.contains("_ViewBinder") || qualifiedName.contains("_ViewBinding") || qualifiedName.equals(R2)) {
        ...
        private static boolean isR2Expression(UElement node) {
            ...
            return (text.equals(R2) || text.contains(".R2")) && parent instanceof UExpression && endsWithAny(parent.asSourceString(), SUPPORTED_TYPES);
        }
