...
public final class InvalidR2UsageDetectorTest {
    ...
    public void noR2Usage() {
        ...
        "class NoR2Usage {}\n")).//
        issues(//
        InvalidR2UsageDetector.ISSUE).run().expectClean();
    }
    ...
    public void usesR2OutsideAnnotations() {
        ...
        "}\n")).//
        issues(//
        InvalidR2UsageDetector.ISSUE).//
        run().//
        expectErrorCount(2).expectWarningCount(0);
    }
