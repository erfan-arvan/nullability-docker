...
public class ButterKnifeTest {
    ...
    private static final Property<View, Boolean> PROPERTY_ENABLED = new Property<View, Boolean>(Boolean.class, "enabled") {
    ...
    private static final ButterKnife.Setter<View, Boolean> SETTER_ENABLED = new ButterKnife.Setter<View, Boolean>() {

        @Override
        public void set(@NonNull View view, Boolean value, @Nullable() int index) {
    ...
    private static final ButterKnife.Action<View> ACTION_DISABLE = new ButterKnife.Action<View>() {
        ...
        @Override
        public void apply(@NonNull View view, @Nullable() int index) {
    ...
    // Clear out cache of binders before and after each test.
    @Before
    // Clear out cache of binders before and after each test.
    @After
