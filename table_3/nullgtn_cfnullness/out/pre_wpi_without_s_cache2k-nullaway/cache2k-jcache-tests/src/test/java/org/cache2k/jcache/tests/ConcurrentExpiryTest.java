...
public class ConcurrentExpiryTest extends AdditionalTestSupport<Integer, String> {
    ...
    private CacheLoader<Integer, String> loader = new CacheLoader<Integer, String>() {
        ...
        @Override
        public Map<Integer, String> loadAll(@Nullable() final Iterable<? extends Integer> keys) throws CacheLoaderException {
    ...
    protected void extraSetup(ConfigurationBuilder<Integer, String> cfg) {
        ...
        cfg.syncListener(new CacheEntryExpiredListener<Integer, String>() {
            ...
            @Override
            public void onExpired(@Nullable() final Iterable<CacheEntryEvent<? extends Integer, ? extends String>> events) throws CacheEntryListenerException {
        ...
        cfg.syncListener(new CacheEntryCreatedListener<Integer, String>() {
            ...
            @Override
            public void onCreated(@Nullable() final Iterable<CacheEntryEvent<? extends Integer, ? extends String>> cacheEntryEvents) throws CacheEntryListenerException {
    ...
    public void testExpireAnywayWhileReadInvoke() throws Exception {
        ...
        cache.invoke(1, new EntryProcessor<Integer, String, Object>() {
            ...
            @Override
            @Nullable()
            public Object process(final MutableEntry<Integer, String> entry, @Nullable() final Object... arguments) throws EntryProcessorException {
                entry.getValue();
                while (expireListenerCalled.get() > 0) ;
                return null;
            }
