...
public class TestSupport {
    ...
    public static ObjectName calculateObjectName(Cache cache, MBeanType type) {
        try {
            ObjectName name = new ObjectName("javax.cache:type=" + type + "," + "CacheManager=" + mbeanSafe(cache.getCacheManager().getURI().toString()) + ",Cache=" + mbeanSafe(cache.getName()));
            return name;
    ...
    public static enum MBeanType {
        ...
        CacheConfiguration, CacheStatistics
    }
}
