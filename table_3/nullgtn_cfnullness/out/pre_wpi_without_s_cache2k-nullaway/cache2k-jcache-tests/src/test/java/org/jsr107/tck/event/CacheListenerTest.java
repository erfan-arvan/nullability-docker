...
public class CacheListenerTest extends CacheTestSupport<Long, String> {
    ...
    protected MutableConfiguration<Long, String> extraSetup(MutableConfiguration<Long, String> configuration) {
        ...
        clientListener = new CacheEntryListenerClient<>(cacheEntryListenerServer.getInetAddress(), cacheEntryListenerServer.getPort());
    ...
    */
    ...
    private static class MyCacheEntryEventFilter implements CacheEntryEventFilter<Long, String>, Serializable {
        ...
        public boolean evaluate(CacheEntryEvent<? extends Long, ? extends String> event) throws CacheEntryListenerException {
            return event.getValue().contains("a") || event.getValue().contains("e") || event.getValue().contains("i") || event.getValue().contains("o") || event.getValue().contains("u");
        }
    }
...
*/
        ...
        CacheEntryListenerConfiguration<Long, String> listenerConfiguration = new MutableCacheEntryListenerConfiguration<Long, String>(FactoryBuilder.factoryOf(clientListener), FactoryBuilder.factoryOf(new MyCacheEntryEventFilter()), true, true);
        cache.registerCacheEntryListener(listenerConfiguration);
    ...
    public void testDynamicRegistration() {
        ...
        MutableCacheEntryListenerConfiguration<Long, String> listenerConfiguration = new MutableCacheEntryListenerConfiguration(FactoryBuilder.factoryOf(secondListener), null, false, true);
        cache.registerCacheEntryListener(listenerConfiguration);
    ...
    public void testDeregistration() {
        assertEquals(1, getConfigurationCacheEntryListenerConfigurationSize(cache));
        MyCacheEntryListener secondListener = new MyCacheEntryListener<Long, String>();
        MutableCacheEntryListenerConfiguration<Long, String> secondListenerConfiguration = new MutableCacheEntryListenerConfiguration(FactoryBuilder.factoryOf(secondListener), null, false, true);
    ...
    static class MyBrokenCacheEntryListener<K, V> implements CacheEntryCreatedListener<K, V>, CacheEntryUpdatedListener<K, V>, CacheEntryExpiredListener<K, V>, CacheEntryRemovedListener<K, V>, Serializable {
        ...
        @Override
        public void onExpired(@Nullable() Iterable<CacheEntryEvent<? extends K, ? extends V>> events) throws CacheEntryListenerException {
