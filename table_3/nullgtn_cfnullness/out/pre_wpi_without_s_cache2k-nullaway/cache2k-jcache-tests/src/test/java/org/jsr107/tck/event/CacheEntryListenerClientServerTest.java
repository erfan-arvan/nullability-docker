...
public class CacheEntryListenerClientServerTest {
    ...
    public void shouldHandleCacheEntryEventFromServerWithClient() throws Exception {
        ...
        CacheEntryListenerServer<String, String> serverListener = new CacheEntryListenerServer<>(10011, String.class, String.class);
        serverListener.addCacheEventListener(listener);
        try {
            serverListener.open();
            CacheEntryListenerClient<String, String> clientListener = new CacheEntryListenerClient<>(serverListener.getInetAddress(), serverListener.getPort());
