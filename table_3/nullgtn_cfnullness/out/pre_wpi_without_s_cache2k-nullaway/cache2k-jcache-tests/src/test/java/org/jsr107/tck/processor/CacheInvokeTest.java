...
public class CacheInvokeTest extends CacheTestSupport<Integer, String> {
    ...
    public void invokeAllEntryProcessorException() {
        ...
        keys.add(123);
        Map<Integer, EntryProcessorResult<Object>> resultMap = cache.invokeAll(keys, new ThrowExceptionEntryProcessor<Integer, String, Object>(IllegalStateException.class));
    ...
    public void invokeAllEntryProcessorReturnsNullResult() {
        Set<Integer> keys = new HashSet<Integer>();
        keys.add(123);
        Map<Integer, EntryProcessorResult<Object>> resultMap = cache.invokeAll(keys, new SetValueCreateEntryReturnDifferentTypeEntryProcessor<Integer, String, Object>(null, "newValue"));
    ...
    public void invokeAllgetResultFromMap() {
        Set<Integer> keys = new HashSet<Integer>();
        keys.add(123);
        Map<Integer, EntryProcessorResult<String>> resultMap = cache.invokeAll(keys, new SetEntryProcessor<Integer, String>("aValue"));
    ...
    public void varArgumentsPassedIn() {
        final Integer key = 123;
        final Integer ret = 456;
        assertEquals(ret, cache.invoke(key, new MultiArgumentHandlingEntryProcessor<Integer, String, Integer>(ret), "These", "are", "arguments", 1L));
        assertFalse(cache.containsKey(key));
    }
    ...
    public void noValueException() {
        ...
        try {
            ...
            assertTrue("expected IllegalAccessError; observed " + rootCause, rootCause instanceof IllegalAccessError);
        }
        assertFalse(cache.containsKey(key));
    }
    ...
    public void removeMissing() {
        ...
        final Integer ret = 456;
        EntryProcessor[] processors = new EntryProcessor[] { new AssertNotPresentEntryProcessor<Integer, String, Integer>(ret), new SetEntryProcessor<Integer, String>(value), new RemoveEntryProcessor<Integer, String, String>(true) };
    ...
    public void removeException() {
        ...
        try {
            ...
            assertTrue("expected IllegalAccessError; observed " + t, t instanceof IllegalAccessError);
        }
        assertEquals(oldValue, cache.get(key));
    }
}
