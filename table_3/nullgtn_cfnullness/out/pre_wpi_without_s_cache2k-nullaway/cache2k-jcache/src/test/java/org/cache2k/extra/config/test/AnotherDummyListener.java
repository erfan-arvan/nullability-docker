...
public class AnotherDummyListener<K, V> extends BaseDummyListener<K, V> {
    ...
    public static class Supplier implements BeanMarker, CustomizationSupplier<AnotherDummyListener> {

        @Override
        public AnotherDummyListener supply(@Nullable() CacheBuildContext buildContext) {
