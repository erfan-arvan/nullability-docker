...
public interface CacheLifeCycleListener {
    ...
    <K, V> void cacheCreated(@Nullable() Cache<K, V> cache, @Nullable() InternalCacheBuildContext<K, V> ctx);

    <K, V> void cacheClosed(@Nullable() Cache<K, V> cache, @Nullable() InternalCacheCloseContext ctx);
}
