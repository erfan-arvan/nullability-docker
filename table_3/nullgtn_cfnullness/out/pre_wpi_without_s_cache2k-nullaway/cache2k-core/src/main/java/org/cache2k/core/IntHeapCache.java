...
public class IntHeapCache<V> extends HeapCache<Integer, V> {
    ...
    @Override
    public Integer extractIntKeyObj(@Nullable() Integer key) {
        return null;
    }

    @Override
    public int extractIntKeyValue(Integer key, @Nullable() int hc) {
        return key;
    }
    ...
    public Hash2<Integer, V> createHashTable() {
        return new Hash2<Integer, V>(this) {
            ...
            @Override
            protected boolean keyObjIsEqual(@Nullable() Integer key, @Nullable() Entry e) {
                return true;
            }
        };
    }
