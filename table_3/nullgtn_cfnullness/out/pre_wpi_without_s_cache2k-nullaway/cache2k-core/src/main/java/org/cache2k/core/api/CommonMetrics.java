...
public interface CommonMetrics {
    ...
    interface Updater extends CommonMetrics {
        ...
        void readThrough(@Nullable() long millis);

        void explicitLoad(@Nullable() long millis);

        void refresh(@Nullable() long millis);
    ...
    class BlackHole implements Updater {
        ...
        @Override
        public void readThrough(@Nullable() long millis) {
        }

        @Override
        public void explicitLoad(@Nullable() long millis) {
        }

        @Override
        public void refresh(@Nullable() long millis) {
        }
