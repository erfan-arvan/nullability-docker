...
public class ExclusiveExecutor implements Executor, Closeable {
    ...
    public ExclusiveExecutor(int threadCount, String threadNamePrefix) {
        ...
        threadPoolExecutor = new ThreadPoolExecutor(corePoolThreadSize, threadCount, 21, TimeUnit.SECONDS, new SynchronousQueue<Runnable>(), HeapCache.TUNABLE.threadFactoryProvider.newThreadFactory(threadNamePrefix), new ThreadPoolExecutor.AbortPolicy());
    }
