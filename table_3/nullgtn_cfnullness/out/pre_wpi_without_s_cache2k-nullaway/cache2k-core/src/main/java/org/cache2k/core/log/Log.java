...
public abstract class Log {
   ...
   */
    ...
    public abstract void debug(@Nullable() String s);

    public abstract void debug(@Nullable() String s, @Nullable() Throwable ex);

    public abstract void info(@Nullable() String s);

    public abstract void info(@Nullable() String s, @Nullable() Throwable ex);

    public abstract void warn(@Nullable() String s);

    public abstract void warn(@Nullable() String s, @Nullable() Throwable ex);
    ...
    public static class Slf4jLogger extends Log {
        ...
        @Override
        public void info(String s, @Nullable() Throwable ex) {
            logger.info(s);
        }
    ...
    public static class SuppressionCounter extends Log {
        ...
        @Override
        public void debug(@Nullable() String s, @Nullable() Throwable ex) {
            debugCount.incrementAndGet();
        }

        @Override
        public void info(@Nullable() String s, @Nullable() Throwable ex) {
        ...
        @Override
        public void warn(@Nullable() String s, @Nullable() Throwable ex) {
            warnCount.incrementAndGet();
        }
