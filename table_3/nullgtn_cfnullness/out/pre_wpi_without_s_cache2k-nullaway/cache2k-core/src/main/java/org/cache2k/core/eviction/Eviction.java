...
public interface Eviction {
     ...
     */
    boolean submitWithoutTriggeringEviction(@Nullable() Entry e);
     ...
     */
    boolean updateWeight(@Nullable() Entry e);
     ...
     */
    void evictEventuallyBeforeInsertOnSegment(@Nullable() int hashCodeHint);
     ...
     */
    <T> T runLocked(@Nullable() Job<T> j);

    void checkIntegrity(@Nullable() IntegrityState integrityState);
