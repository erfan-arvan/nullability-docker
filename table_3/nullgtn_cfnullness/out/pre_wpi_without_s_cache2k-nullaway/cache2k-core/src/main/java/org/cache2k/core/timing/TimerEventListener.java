...
public interface TimerEventListener<K, V> {
     ...
     */
    void timerEventExpireEntry(@Nullable() Entry<K, V> e, @Nullable() Object task);
     ...
     */
    void timerEventRefresh(@Nullable() Entry<K, V> e, @Nullable() Object task);

    /**
     * @param e see {@link #timerEventExpireEntry(Entry, Object)}
     * @param task see {@link #timerEventExpireEntry(Entry, Object)}
     */
    void timerEventProbationTerminated(@Nullable() Entry<K, V> e, @Nullable() Object task);
}
