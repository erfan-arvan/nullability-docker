...
public interface CacheConfigProvider {
     ...
     */
    String getDefaultManagerName(@Nullable() ClassLoader classLoader);
     ...
     */
    Cache2kConfig getDefaultConfig(@Nullable() CacheManager mgr);
     ...
     */
    <K, V> void augmentConfig(@Nullable() CacheManager mgr, @Nullable() Cache2kConfig<K, V> cfg);

    /**
     * List of cache names found in the configuration.
     */
    Iterable<String> getConfiguredCacheNames(@Nullable() CacheManager mgr);
}
