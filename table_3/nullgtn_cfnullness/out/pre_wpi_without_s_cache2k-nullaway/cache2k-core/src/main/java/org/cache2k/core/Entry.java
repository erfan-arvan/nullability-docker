...
public class Entry<K, V> extends CompactEntry<K, V> implements ExaminationEntry<K, V> {
    ...
    public void setRefreshTime(long t) {
        refreshTimeAndState = refreshTimeAndState & ~MODIFICATION_TIME_MASK | ((((t - MODIFICATION_TIME_BASE) << MODIFICATION_TIME_SHIFT)) & MODIFICATION_TIME_MASK);
    }
    ...
    public static String num2processingStateText(int ps) {
        switch(ps) {
            case ProcessingState.DONE:
                return "DONE";
            case ProcessingState.READ:
                return "READ";
            case ProcessingState.READ_COMPLETE:
                return "READ_COMPLETE";
            case ProcessingState.MUTATE:
                return "MUTATE";
            case ProcessingState.LOAD:
                return "LOAD";
            case ProcessingState.LOAD_COMPLETE:
                return "LOAD_COMPLETE";
            case ProcessingState.COMPUTE:
                return "COMPUTE";
            case ProcessingState.REFRESH:
                return "REFRESH";
            case ProcessingState.EXPIRY:
                return "EXPIRY";
            case ProcessingState.EXPIRY_COMPLETE:
                return "EXPIRY_COMPLETE";
            case ProcessingState.WRITE:
                return "WRITE";
            case ProcessingState.WRITE_COMPLETE:
                return "WRITE_COMPLETE";
            case ProcessingState.STORE:
                return "STORE";
            case ProcessingState.STORE_COMPLETE:
                return "STORE_COMPLETE";
            case ProcessingState.NOTIFY:
                return "NOTIFY";
            case ProcessingState.PINNED:
                return "PINNED";
            case ProcessingState.EVICT:
                return "EVICT";
            case ProcessingState.LOAD_ASYNC:
                return "LOAD_ASYNC";
            case ProcessingState.WRITE_ASYNC:
                return "WRITE_ASYNC";
            case ProcessingState.LAST:
                return "LAST";
        }
        return "UNKNOWN";
    }
     ...
     */
    public void processingDone(@Nullable() EntryAction action) {
        processingDone();
    }
