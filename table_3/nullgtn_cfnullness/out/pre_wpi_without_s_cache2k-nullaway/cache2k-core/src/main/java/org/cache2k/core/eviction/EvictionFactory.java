...
public class EvictionFactory {
     ...
     */
    public Eviction constructEviction(InternalCacheBuildContext customizationContext, HeapCacheForEviction hc, HeapCacheListener l, Cache2kConfig config, int availableProcessors) {
