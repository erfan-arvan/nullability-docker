...
public class Operations<K, V> {
    ...
    public Semantic<K, V, V> peek(@Nullable() K key) {
        return PEEK;
    }
    ...
    public Semantic<K, V, V> get(@Nullable() K key) {
        return GET;
    }
    ...
    public static final Semantic GET = new Semantic.MightUpdate() {
        ...
        @Override
        public void mutate(Progress c, @Nullable() ExaminationEntry e) {
            c.load();
        }
    };
    ...
    public final Semantic<K, V, Void> refresh = new Semantic.MightUpdate<K, V, Void>() {
         ...
         */
        @Override
        public void examine(Progress<K, V, Void> c, @Nullable() ExaminationEntry<K, V> e) {
        ...
        @Override
        public void mutate(Progress<K, V, Void> c, @Nullable() ExaminationEntry<K, V> e) {
            c.refresh();
        }
    };

    public Semantic<K, V, ResultEntry<K, V>> getEntry(@Nullable() K key) {
        return GET_ENTRY;
    }
    ...
    public Semantic<K, V, ResultEntry<K, V>> peekEntry(@Nullable() K key) {
        return PEEK_ENTRY;
    }
    ...
    public Semantic<K, V, V> remove(@Nullable() K key) {
        return REMOVE;
    }
    ...
    public Semantic<K, V, Boolean> containsAndRemove(@Nullable() K key) {
    ...
    public Semantic<K, V, Boolean> contains(@Nullable() K key) {
        return CONTAINS;
    }
    ...
    static final Semantic CONTAINS = new Semantic.Read() {
        ...
        @Override
        public void examine(Progress c, @Nullable() ExaminationEntry e) {
            c.result(c.isDataFresh());
            c.noMutation();
        }
    };

    public Semantic<K, V, V> peekAndRemove(@Nullable() K key) {
        return PEEK_REMOVE;
    }
    ...
    public Semantic<K, V, V> peekAndReplace(@Nullable() K key, V value) {
        return new Semantic.MightUpdate<K, V, V>() {
            ...
            @Override
            public void mutate(Progress<K, V, V> c, @Nullable() ExaminationEntry<K, V> e) {
                c.put(value);
            }
        };
    }

    public Semantic<K, V, V> peekAndPut(@Nullable() K key, V value) {
    ...
    public Semantic<K, V, V> computeIfAbsent(@Nullable() K key, Callable<V> function) {
        return new Semantic.MightUpdate<K, V, V>() {
    ...
    public Semantic<K, V, V> put(@Nullable() K key, V value) {
     ...
     */
    public Semantic<K, V, Boolean> putIfAbsent(@Nullable() K key, V value) {
        return new Semantic.MightUpdate<K, V, Boolean>() {

            @Override
            public void examine(Progress<K, V, Boolean> c, @Nullable() ExaminationEntry<K, V> e) {
                if (!c.isDataFreshOrMiss()) {
                    c.result(true);
                    c.wantMutation();
                } else {
            ...
            @Override
            public void mutate(Progress<K, V, Boolean> c, @Nullable() ExaminationEntry<K, V> e) {
                c.put(value);
            }
        };
    }
     ...
     */
    public Semantic<K, V, Boolean> replace(@Nullable() K key, V value) {
        return new Semantic.MightUpdate<K, V, Boolean>() {
    ...
    public Semantic<K, V, Boolean> replace(@Nullable() K key, V value, V newValue) {
        return new Semantic.MightUpdate<K, V, Boolean>() {
    ...
    public Semantic<K, V, Boolean> remove(@Nullable() K key, V value) {
        return new Semantic.MightUpdate<K, V, Boolean>() {
    ...
    public <R> Semantic<K, V, R> invoke(K key, EntryProcessor<K, V, R> processor) {
        return new Semantic.Base<K, V, R>() {
            ...
            public void start(Progress<K, V, R> c) {
                MutableEntryOnProgress<K, V> mutableEntry = new MutableEntryOnProgress<K, V>(key, c, null, false);
                try {
            ...
            public void examine(Progress<K, V, R> c, ExaminationEntry<K, V> e) {
                ...
                MutableEntryOnProgress<K, V> mutableEntry = new MutableEntryOnProgress<K, V>(key, c, e, false);
                try {
                    R result = processor.process(mutableEntry);
                    c.result(result);
                } catch (NeedsLockRestartException ex) {
            ...
            public void mutate(Progress<K, V, R> c, ExaminationEntry<K, V> e) {
                ...
                if (mutableEntryResult == null) {
                    mutableEntryResult = new MutableEntryOnProgress<K, V>(key, c, e, true);
                    try {
             ...
             */
            @Override
            public void loaded(@Nullable() Progress<K, V, R> c, @Nullable() ExaminationEntry<K, V> e) {
            }
        };
    }
    ...
    public Semantic<K, V, Void> expire(@Nullable() K key, long t) {
        return new Semantic.MightUpdate<K, V, Void>() {

            @Override
            public void examine(Progress<K, V, Void> c, @Nullable() ExaminationEntry<K, V> e) {
                if (t == ExpiryTimeValues.NOW || t == ExpiryTimeValues.REFRESH) {
