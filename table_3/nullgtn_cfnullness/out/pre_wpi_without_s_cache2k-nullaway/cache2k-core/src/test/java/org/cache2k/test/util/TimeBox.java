...
public class TimeBox {
    ...
    public class Noop extends Chain {
        ...
        @Override
        public void concludesMaybe(@Nullable() Runnable r) {
        }

        @Override
        public TimeBox within(@Nullable() long timeBox) {
            return new TimeBox(null, 0) {

                @Override
                public TimeBox perform(@Nullable() Runnable r) {
                    return this;
                }

                @Override
                public Chain expectMaybe(@Nullable() Runnable r) {
                    return Noop.this;
                }
            };
        }
