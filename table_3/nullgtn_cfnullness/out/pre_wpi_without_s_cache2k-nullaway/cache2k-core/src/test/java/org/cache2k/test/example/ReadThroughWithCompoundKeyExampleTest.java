...
public class ReadThroughWithCompoundKeyExampleTest {
    ...
    }.name(this + "-routeToAirline").eternal(true).loader(new CacheLoader<Route, String>() {
    ...
    private String findFavoriteAirline(@Nullable() String origin, @Nullable() String destination) {
        return "People Air";
    }
