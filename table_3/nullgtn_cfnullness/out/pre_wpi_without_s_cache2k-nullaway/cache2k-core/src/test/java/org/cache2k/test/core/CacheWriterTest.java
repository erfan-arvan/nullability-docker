...
public class CacheWriterTest extends TestingBase {
    ...
    public static final String EXCEPTION_TEXT = "org.cache2k.io.CacheWriterException: " + "java.lang.Exception: test exception, value: 777";
    ...
    public void testTriggerLoadWithGetDoesNotCallWriter() {
        MyWriter w = new MyWriter();
        Cache<Integer, Integer> c = builder(Integer.class, Integer.class).writer(w).loader(new CacheLoader<Integer, Integer>() {
