...
public interface Constants {
    ...
    ResiliencePolicy<?, ?> RESILIENCE_CACHE_AND_SUPPRESS_EXCEPTIONS = new ResiliencePolicy<Object, Object>() {
        ...
        @Override
        public long suppressExceptionUntil(@Nullable() Object key, @Nullable() LoadExceptionInfo<Object> loadExceptionInfo, @Nullable() CacheEntry<Object, Object> cachedEntry) {
            return ETERNAL;
        }

        @Override
        public long retryLoadAfter(@Nullable() Object key, @Nullable() LoadExceptionInfo<Object> loadExceptionInfo) {
            return ETERNAL;
        }
    };
