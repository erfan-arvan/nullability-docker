...
public class ListenerTest {
        ...
        Cache<Integer, Integer> c = target.cache(new CacheRule.Specialization<Integer, Integer>() {
            ...
            public void extend(Cache2kBuilder<Integer, Integer> b) {
                b.addAsyncListener(new CacheEntryCreatedListener<Integer, Integer>() {
                    ...
                    @Override
                    public void onEntryCreated(@Nullable() Cache<Integer, Integer> c, @Nullable() CacheEntry<Integer, Integer> e) {
                        try {
                            fire.await();
        ...
        Cache<Integer, Integer> c = target.cache(new CacheRule.Specialization<Integer, Integer>() {
            ...
            public void extend(Cache2kBuilder<Integer, Integer> b) {
                b.addAsyncListener(new CacheEntryUpdatedListener<Integer, Integer>() {
                    ...
                    @Override
                    public void onEntryUpdated(@Nullable() Cache<Integer, Integer> cache, @Nullable() CacheEntry<Integer, Integer> currentEntry, @Nullable() CacheEntry<Integer, Integer> entryWithNewData) {
                        try {
                            fire.await();
                        } catch (InterruptedException ignore) {
                        }
        ...
        Cache<Integer, Integer> c = target.cache(new CacheRule.Specialization<Integer, Integer>() {
            ...
            public void extend(Cache2kBuilder<Integer, Integer> b) {
                b.addAsyncListener(new CacheEntryRemovedListener<Integer, Integer>() {
                    ...
                    @Override
                    public void onEntryRemoved(@Nullable() Cache<Integer, Integer> c, @Nullable() CacheEntry<Integer, Integer> e) {
                        try {
                            fire.await();
                        } catch (InterruptedException ignore) {
                        }
        ...
        Cache<Integer, Integer> c = target.cache(new CacheRule.Specialization<Integer, Integer>() {
            ...
            public void extend(Cache2kBuilder<Integer, Integer> b) {
                b.addAsyncListener(new CacheEntryEvictedListener<Integer, Integer>() {
                    ...
                    @Override
                    public void onEntryEvicted(@Nullable() Cache<Integer, Integer> c, @Nullable() CacheEntry<Integer, Integer> e) {
                        try {
                            block.await();
                        } catch (InterruptedException ignore) {
                        }
        ...
        final Cache<Integer, Integer> c = target.cache(new CacheRule.Specialization<Integer, Integer>() {
            ...
            public void extend(Cache2kBuilder<Integer, Integer> b) {
                b.addListener(new CacheEntryEvictedListener<Integer, Integer>() {
                    ...
                    @Override
                    public void onEntryEvicted(Cache<Integer, Integer> c, @Nullable() CacheEntry<Integer, Integer> e) {
                        c.toString();
                        callCount.incrementAndGet();
                    }
                }).entryCapacity(2);
        ...
        Cache<Integer, Integer> c = target.cache(new CacheRule.Specialization<Integer, Integer>() {
            ...
            public void extend(Cache2kBuilder<Integer, Integer> b) {
                b.addAsyncListener(new CacheEntryUpdatedListener<Integer, Integer>() {
                    ...
                    @Override
                    public void onEntryUpdated(@Nullable() Cache<Integer, Integer> cache, @Nullable() CacheEntry<Integer, Integer> currentEntry, CacheEntry<Integer, Integer> entryWithNewData) {
    ...
    public void asyncUpdateListenerException() {
        ...
        Cache<Integer, Integer> c = target.cache(new CacheRule.Specialization<Integer, Integer>() {
            ...
            @Override
            public void extend(Cache2kBuilder<Integer, Integer> b) {
                b.name(logName).eternal(true).addAsyncListener(new CacheEntryUpdatedListener<Integer, Integer>() {
        ...
        Cache<Integer, Integer> c = target.cache(new CacheRule.Specialization<Integer, Integer>() {
            ...
            public void extend(Cache2kBuilder<Integer, Integer> b) {
                b.addAsyncListener(new CacheEntryExpiredListener<Integer, Integer>() {
                    ...
                    @Override
                    public void onEntryExpired(@Nullable() Cache<Integer, Integer> c, @Nullable() CacheEntry<Integer, Integer> e) {
    ...
    public void listenerExampleForDocumentation() {
        Cache2kBuilder.of(Integer.class, Integer.class).addListener(new CacheEntryCreatedListener<Integer, Integer>() {

            @Override
            public void onEntryCreated(@Nullable() Cache<Integer, Integer> cache, CacheEntry<Integer, Integer> entry) {
    ...
    public void customExecutor() {
        ...
        Cache<Integer, Integer> c = Cache2kBuilder.of(Integer.class, Integer.class).addAsyncListener(new CacheEntryCreatedListener<Integer, Integer>() {

            @Override
            public void onEntryCreated(@Nullable() Cache<Integer, Integer> cache, @Nullable() CacheEntry<Integer, Integer> entry) {
            }
    ...
    public void expiredWhileInitialLoad() {
        ...
        target.run(new CountSyncEvents() {
            ...
            @Override
            public void extend(Cache2kBuilder<Integer, Integer> b) {
                b.with(CoreConfig.class, b2 -> b2.timerReference(clock));
    ...
    public void expiredWhileReloadUpdate() {
        ...
        target.run(new CountSyncEvents() {
            ...
            public void extend(Cache2kBuilder<Integer, Integer> builder) {
                builder.with(CoreConfig.class, b2 -> b2.timerReference(clock)).expireAfterWrite(expireAfterWrite, TimeUnit.MILLISECONDS).loader(new CacheLoader<Integer, Integer>() {
    ...
    abstract static class CountSyncEvents extends CacheRule.Context<Integer, Integer> {
        ...
        private void checkCondition() {
            assertTrue("Get a created event before something is removed, evicted or expired", created.get() >= (evicted.get() + expired.get() + removed.get()));
        }
        ...
        public void extend(Cache2kBuilder<Integer, Integer> b) {
            b.addListener(new CacheEntryCreatedListener<Integer, Integer>() {
                ...
                @Override
                public void onEntryEvicted(@Nullable() Cache<Integer, Integer> cache, @Nullable() CacheEntry<Integer, Integer> entry) {
                ...
                @Override
                public void onEntryExpired(@Nullable() Cache<Integer, Integer> cache, @Nullable() CacheEntry<Integer, Integer> entry) {
