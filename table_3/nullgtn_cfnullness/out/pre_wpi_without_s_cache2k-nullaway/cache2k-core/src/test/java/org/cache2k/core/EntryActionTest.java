...
public class EntryActionTest extends TestingBase {
    ...
    public void testAbort() {
        ...
        Semantic op = new Semantic<Integer, Integer, Object>() {
             ...
             */
            @Override
            public void examine(Progress<Integer, Integer, Object> c, @Nullable() ExaminationEntry<Integer, Integer> e) {
            ...
            @Override
            public void mutate(Progress<Integer, Integer, Object> c, @Nullable() ExaminationEntry<Integer, Integer> e) {
                c.put(123);
            }

            @Override
            public void loaded(@Nullable() Progress<Integer, Integer, Object> c, @Nullable() ExaminationEntry<Integer, Integer> e) {
            }
        };
        bc.execute(1, op);
