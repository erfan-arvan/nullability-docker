...
public class CacheManagerAndCacheLifeCycleTest {
    ...
    public void testToStringAnon() {
        Cache<Integer, Integer> c = Cache2kBuilder.of(Integer.class, Integer.class).eternal(true).build();
        c.toString();
        c.close();
    }
    ...
    public void testToString() {
        Cache<Integer, Integer> c = Cache2kBuilder.of(Integer.class, Integer.class).name("testToString").eternal(true).build();
    ...
    public void testToStringWithManager() {
        ...
        Cache<Integer, Integer> c = Cache2kBuilder.of(Integer.class, Integer.class).manager(cm).name("testToString").eternal(true).build();
