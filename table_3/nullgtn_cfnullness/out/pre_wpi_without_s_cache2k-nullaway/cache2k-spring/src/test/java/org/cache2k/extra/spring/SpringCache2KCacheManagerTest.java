...
public class SpringCache2KCacheManagerTest {
    ...
    private SpringCache2kCacheManager getManager() {
        return new SpringCache2kCacheManager(CacheManager.getInstance(SpringCache2KCacheManagerTest.class.getSimpleName() + "separate"));
    }

    @Test(expected = IllegalArgumentException.class)
    public void testMissing() {
        SpringCache2kCacheManager m = new SpringCache2kCacheManager(CacheManager.getInstance(SpringCache2KCacheManagerTest.class.getSimpleName() + "notConfigured"));
    ...
    @Test
    public void testAll() {
        SpringCache2kCacheManager m = new SpringCache2kCacheManager(SpringCache2KCacheManagerTest.class.getSimpleName() + "notConfigured");
        ...
        m.setCaches(Collections.singletonList(Cache2kBuilder.forUnknownTypes().name("other").config()));
        assertEquals(2, m.getCacheNames().size());
    }

    @Test
    public void testAddCaches() {
        SpringCache2kCacheManager m = new SpringCache2kCacheManager(SpringCache2KCacheManagerTest.class.getSimpleName() + "addCaches");
    ...
    public void testDefaultSetup() {
        SpringCache2kCacheManager m = new SpringCache2kCacheManager(SpringCache2KCacheManagerTest.class.getSimpleName() + "defaultSetup");
    ...
    public void testDynamicCache() {
        SpringCache2kCacheManager m = new SpringCache2kCacheManager(SpringCache2KCacheManagerTest.class.getSimpleName() + "dynamicCache");
