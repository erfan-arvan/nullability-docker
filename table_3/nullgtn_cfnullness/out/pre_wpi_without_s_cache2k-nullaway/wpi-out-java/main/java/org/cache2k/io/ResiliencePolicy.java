...
public interface ResiliencePolicy<K, V> extends ExpiryTimeValues, Customization<K, V> {
    ...
    ResiliencePolicy<?, ?> DISABLED_POLICY = new ResiliencePolicy<Object, Object>() {
        ...
        @org.checkerframework.checker.initialization.qual.Initialized
        @org.checkerframework.checker.nullness.qual.NonNull
        public long suppressExceptionUntil(@org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull Object key, @org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull LoadExceptionInfo<Object> loadExceptionInfo, @org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull CacheEntry<Object, Object> cachedEntry) {
            return NOW;
        }
        ...
        @org.checkerframework.checker.initialization.qual.Initialized
        @org.checkerframework.checker.nullness.qual.NonNull
        public long retryLoadAfter(@org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull Object key, @org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull LoadExceptionInfo<Object> loadExceptionInfo) {
            return NOW;
        }
    };
    ...
    @org.checkerframework.checker.initialization.qual.Initialized
    @org.checkerframework.checker.nullness.qual.NonNull
    long suppressExceptionUntil(@Nullable() K key, @Nullable() LoadExceptionInfo<K> loadExceptionInfo, @Nullable() CacheEntry<K, V> cachedEntry);
    ...
    @org.checkerframework.checker.initialization.qual.Initialized
    @org.checkerframework.checker.nullness.qual.NonNull
    long retryLoadAfter(@Nullable() K key, @Nullable() LoadExceptionInfo<K> loadExceptionInfo);
}
