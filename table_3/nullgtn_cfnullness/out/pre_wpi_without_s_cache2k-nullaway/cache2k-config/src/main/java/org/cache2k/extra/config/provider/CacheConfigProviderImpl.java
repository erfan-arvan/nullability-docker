...
public class CacheConfigProviderImpl extends ConfigurationProvider implements CacheConfigProvider {
    ...
    private ConfigurationContext getManagerContext(CacheManager mgr) {
        ...
        synchronized (this) {
            ...
            Map<CacheManager, ConfigurationContext> m2 = new HashMap<CacheManager, ConfigurationContext>(manager2defaultConfig);
            m2.put(mgr, ctx);
    ...
    private void applyDefaultConfigurationIfPresent(ConfigurationContext ctx, ParsedConfiguration pc, Cache2kConfig defaultConfiguration) {
