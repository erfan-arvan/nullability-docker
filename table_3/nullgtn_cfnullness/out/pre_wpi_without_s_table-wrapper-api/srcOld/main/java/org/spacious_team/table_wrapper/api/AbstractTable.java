...
public abstract class AbstractTable<R extends ReportPageRow> implements Table {
    ...
    private static Map<TableColumn, Integer> getHeaderDescription(AbstractReportPage<?> reportPage, TableCellRange tableRange, Class<? extends TableColumnDescription> headerDescription, int headersRowCount) {
