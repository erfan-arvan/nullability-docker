...
abstract class RemoteViewsAction extends Action<RemoteViewsAction.RemoteViewsTarget> {
    ...
    RemoteViewsAction(Picasso picasso, Request data, Target<RemoteViewsTarget> wrapper, @Nullable Callback callback) {
    ...
    static class AppWidgetAction extends RemoteViewsAction {
        ...
        AppWidgetAction(Picasso picasso, Request data, Target<RemoteViewsTarget> wrapper, int[] appWidgetIds, @Nullable Callback callback) {
    ...
    static class NotificationAction extends RemoteViewsAction {
        ...
        NotificationAction(Picasso picasso, Request data, Target<RemoteViewsTarget> wrapper, int notificationId, Notification notification, @Nullable String notificationTag, @Nullable Callback callback) {
            super(picasso, data, wrapper, callback);
