...
public class RequestCreator {
     ...
     * given {@code viewId}. This is used for loading bitmaps into a {@link Notification}.
     */
    public void into(@NonNull RemoteViews remoteViews, @IdRes int viewId, int notificationId, @NonNull Notification notification, String notificationTag) {
     ...
     * given {@code viewId}. This is used for loading bitmaps into a {@link Notification}.
     */
    public void into(@NonNull RemoteViews remoteViews, @IdRes int viewId, int notificationId, @NonNull Notification notification, String notificationTag, Callback callback) {
        long started = System.nanoTime();
        if (remoteViews == null) {
        ...
        Request request = createRequest(started);
        Target<RemoteViewsTarget> remoteTarget = new Target<>(new RemoteViewsTarget(remoteViews, viewId), errorResId);
        RemoteViewsAction action = new NotificationAction(picasso, request, remoteTarget, notificationId, notification, notificationTag, callback);
     ...
     * given {@code viewId}. This is used for loading bitmaps into all instances of a widget.
     */
    public void into(@NonNull RemoteViews remoteViews, @IdRes int viewId, int appWidgetId, Callback callback) {
    ...
    public void into(@NonNull RemoteViews remoteViews, @IdRes int viewId, @NonNull int[] appWidgetIds, Callback callback) {
        ...
        Request request = createRequest(started);
        Target<RemoteViewsTarget> remoteTarget = new Target<>(new RemoteViewsTarget(remoteViews, viewId), errorResId);
        RemoteViewsAction action = new AppWidgetAction(picasso, request, remoteTarget, appWidgetIds, callback);
        performRemoteViewInto(request, action);
    }
